...
mo_loc = load('cbd_d4h_hf_loc.molden') #load("cbd_d4h_casscf44_loc.molden")
loc_MO_pipek = mo_loc[2]

#print(nao_localized)


'''boys_loc_core = lo.boys.Boys(mol, mo_coeff=rhf.mo_coeff[:,[0,1,2,3,8,9,12,13]]).kernel()

localized_MO[:,0] = boys_loc_core[:,0]
localized_MO[:,1] = boys_loc_core[:,1]
localized_MO[:,2] = boys_loc_core[:,2]
localized_MO[:,3] = boys_loc_core[:,3]
localized_MO[:,8] = boys_loc_core[:,4]
localized_MO[:,9] = boys_loc_core[:,5]
localized_MO[:,12] = boys_loc_core[:,6]
localized_MO[:,13] = boys_loc_core[:,7]'''
