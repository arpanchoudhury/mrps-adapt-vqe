...
def get_geom():
    xyz = '''
        O            0.0000000000       -0.0000000000        0.0794302300
        H            0.0000000000        0.7142826200       -0.4681100300
        H            0.0000000000       -0.7142826200       -0.4681100300
        '''
...
mo_loc = load('water-0.9a_hf.molden') #load("cbd_d4h_casscf44_loc.molden")
...
original_as_transformer = ActiveSpaceTransformer(4, 4, active_orbitals=[3-1,4-1,6-1,7-1])
...
active_space_list = [[3-1,7-1],[4-1,6-1]]    # index of canonical LMOs
